...
public class TestPermutate{
	...
	public static void test_recursive_backtracking(int n){
		...
		try{
			HelperPermutate.permTester.toCSV(HelperPermutate.method);		
		}
		catch(Exception e){}
	...
	public static void test_linkedlist(int n){
		System.out.println("\n*** Testing linkedlist ***");
		HelperPermutate.reset();
		char[] a = HelperPermutate.genArray(n);
		HelperPermutate.method = HelperPermutate.LINKEDLIST;
		HelperPermutate.permTester = new PermTester(HelperPermutate.method, n);
		double before = System.currentTimeMillis();
		Permutate.linkedlist(a,HelperPermutate.doit);
		double after = System.currentTimeMillis();
		System.out.println("\n*** Count of linkedlist = " + HelperPermutate.swaps + " (" + (after - before) + " ms)");
		HelperPermutate.permTester.ensureComplete();
		try{
			HelperPermutate.permTester.toCSV(HelperPermutate.method);	
		}
