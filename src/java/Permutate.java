...
public class Permutate{
	...
	*/
    ...
    /**
     * @author Josh
     * Metod used a list for change the elements of permutaions
     * @param a string used for concatenate the permutations
     * @param conjunto list have the elements of permutation     
     * @param doit to print the permutation
     */
